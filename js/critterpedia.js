...
var GiantSnake = {no:18, name:"Giant Snakehead", smonth:6, emonth:8, loc:"Pond", size:4, bells:5500, desc:"Giant snakeheads get their name from the fact that their heads look like those of snakes. Their scales and patterns also look like snakes', really bringing the resemblance to a high degree. They have sharp teeth, so don't poke your finger anywhere near their mouths! Both males and females are well known for protecting their eggs and offspring. They will scare off any other fish that approach by frantically waving their tails.", chk:0};
...
var GreatPurpleEmperor = {no:6, name: "Great Purple Emperor", smonth:5, emonth:8, stime:8, etime:19, loc:"Flying", bells:3000, desc:"There's an old saying among some of my contemporaries: \"Butterflies are beautiful, yet moths are monstrous.\" Well if you were to ask me, I'd say they're all the same! By which I mean disgusting! Truly hoo-riffic, wot wot! Hooo... But I digress...", chk:0};
...
var QueenAlexandria = {no:11, name:"Queen Alexandria's Birdwing", smonth:5, emonth:9, stime:8, etime:16, loc:"Flying", bells:2500, desc:"I do not know what Blathers says about Queen Alexandria's Butterfly", chk:0};
...
var WalkingLeaf = {no:66, name:"Walking Leaf", smonth:7, emonth:8, stime:0, etime:23, loc:"Ground", bells:600, desc:"As you can see, walking leafs are extremely proficient at mimicking the appearance of leaves. What torments me is this: they also EAT leaves... Do they look at one another and think, \"mmmmmmmm\"?", chk:0}
...
function Show(critter)
{
    ...
    var fishimage = "img/"+ list + "/" + critter.name + ".png";
