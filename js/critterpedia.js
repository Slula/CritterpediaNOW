...
var Pike = {name:"Pike", smonth:9, emonth:12, stime:0, etime:23, loc:"River", size:4, bells:1800, desc:"Pikes are only found in cold water, so they cannot live in warmer parts of the world. They can grow over three feet long and as such are a very popular fish with anglers. Pike have a slightly protruding jaw and large mouths with sharp teeth, making them powerful predators. They use these teeth for tearing apart not only other fish but also birds and other aquatic creatures."};
...
var Stringfish = {name:"Stringfish", smonth:12, emonth:3, stime:16, etime:9, loc:"River (Clifftop)", size:5, bells:15000, desc:"The stringfish grows slowly, but also lives quite a long time for a fish, with up to 15 years being typical. Consequently, while it takes a while, they can get quite large—perhaps even up to six feet long! The stringfish is perhaps the best embodiment in the fish world of 'slow and steady wins the race.'"};
...
var Betta = {name:"Betta", smonth:5, emonth:10, stime:9, etime:16, loc:"River", size:1, bells:2500, desc:"i dont know what blathers says about the betta..."};
...
var SeaButterfly = {name:"Sea Butterfly", smonth:12, emonth:3, stime:0, etime:23, loc:"Ocean", size:0, bells:1000, desc:"Such mystery! Such grace! Did you know that the sea butterfly's scientific name is Thecosomata? A very rough translation of that is 'shell body.' Indeed, this illustrious creature is related to snails! However, it reminds me much more of an elegant feathered friend, the way it flies through the water. With such grace in flying, one shouldn't wonder if it's related to the owl, hoo hoo!"};
...
var Surgeonfish = {name:"Surgeonfish", smonth:4, emonth:9, stime:0, etime:23, loc:"Ocean", size:1, bells:1000, desc:"These tropical fish sport beautiful, yellow, triangular tails and elegant black lines on dazzling blue bodies. Personalitywise, the surgeonfish is actually rather laid back and timid. They seek out gaps in coral or between rocks for the greatest amount of protection while sleeping. "};
var ButterflyFish = {name:"Butterfly Fish", smonth:4, emonth:9, stime:0, etime:23, loc:"Ocean", size:1, bells:1000, desc:"Butterfly fish are considered very cute pets, popular because of their beautiful nature. They glide through the warm seas by flapping their yellow bodies as if they were butterflies. Their diets are surprisingly hardy, as they gobble coral and poisonous anemones using narrow mouths. Butterfly-fish couples have been known to live together for 10 years or more. Often they can be seen swimming around in pairs. You'll likely never find a better underwater romance."};
...
var BlueMarlin = {name:"Blue Marlin", smonth:7, emonth:9, smonth2:11, emonth2:4, stime:0, etime:23, loc:"Pier", size:4, bells:10000, desc:"The blue marlin has a distinctive angular shape and no scales. It is an unusual relative of the tuna. These mighty fish can exceed 13 feet from bill to tail. Some accounts even have it fighting with whales! No wonder it's a popular target for sport fishing: unlike most fish, it seems like a worthy opponent."};
...
var Suckerfish = {name:"Suckerfish", smonth:6, emonth:9, stime:0, etime:23, loc:"Ocean", size:6, bells:1500, desc:"I don't know what Blathers says about the suckerfish..."};
