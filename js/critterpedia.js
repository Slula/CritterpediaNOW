...
var Coelacanth = {name:"Coelacanth", smonth:1, emonth:12, stime:0, etime:23, loc:"Ocean (Rain)", size:5, bells:15000, desc:"The coelacanth is a deep-sea fish that has been around since the age of the dinosaurs. They were long thought extinct, so when living specimens were discovered, it was quite a shock! Now I'll just have to figure out where in the museum to display it- fish or fossils!", chk:0};
...
var CommonButterfly = {name:"Common Butterfly", smonth:9, emonth:6, stime:4, etime:19, loc:"Flying", bells:160, desc:"The common butterfly would have you believe it is but a beautiful friend flitting prettily about the flowers. Bah, I say! They may seem innocent things with their pretty white wings, but they hide a dark side! The common butterfly caterpillar is called a cabbage worm, you see, and it's a most voracious pest. The ravenous beasts chew through cabbage, broccoli, kale and the like with a devastating gusto. And my feathers! Their green coloring is truly GROSS! A hoo-rrific hue, I say."};
var YellowButterfly = {name:"Yellow Butterfly", smonth:3, emonth:6, smonth2:9, emonth2:10, stime:4, etime:19, loc:"Flying", bells:160, desc:"Allow me to enlighten you... The yellow butterfly is named for its yellow wings. Need I say more? If I must, then allow me to note that the female yellow butterfly can lay up to 600 eggs at a time! Bleech! And their creepy crawly caterpillars just love to chomp on clover plants. A recipe for disaster, I say. Just imagine reaching for a four-leaf clover, only to touch a larva instead! Yuck! The worst of luck!"};
var TigerButterfly = {name:"Tiger Butterfly", smonth:3, emonth:9, stime:4, etime:19, loc:"Flying", bells:240, desc:"Tiger butterflies are known for their majestic wings, which many consider quite beautiful. Truth be told, I find them monstrous! Those strange striped patterns... They give this owl the goose bumps! And while you may imagine young tiger butterfly larvae to look like lovely green caterpillars... it's not so! Why, when tiger butterflies are but babes, they're covered in unsightly white, brown, and black spots. In this way, they camouflage themselves as...as...bird droppings! Putrid pests, indeed!"};
...
function ShowFish(fish)
{
    ...
    var start = months[fish.smonth - 1];
    var end = months[fish.emonth - 1];
    var timespan = start + "-" + end;
    console.log(fish.smonth2);
    if(fish.smonth2 == null)
    {}
    else
    {
        var start2 = months[fish.smonth2 - 1];
        var end2 = months[fish.emonth2 - 1];
